...
interface SalaryRecord {
  id: string;
  employeeName: string;
  employeeType: 'EMPLOYEE' | 'TRAINER' | 'MENTOR' | 'AGENT';
  amount: number;
  pfAmount: number;
  tdsAmount: number;
  commission: number;
          ...
          {['EMPLOYEE', 'TRAINER', 'MENTOR', 'AGENT'].map(type => {
            ...
            return (
              <div key={type} className="card-premium p-4">
                ...
                <h3 className="text-xl font-bold text-slate-800">{stat ? formatCurrency(stat._sum.amount || 0) : '₹0'}</h3>
            ...
            <form onSubmit={handleCreate} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select value={formData.employeeType} onChange={e => setFormData({...formData, employeeType: e.target.value as any})} className="input-field">
