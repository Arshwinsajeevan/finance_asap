    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <MetricCard 
          ...
          value={`${Math.round((data.stats.budgetUsed / (data.stats.totalBudget || 1)) * 100) || 0}%`}
        ...
        <MetricCard 
          ...
          value={formatCurrency(data.revenueSplit?.donors || 0)} 
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-1 opacity-90">
                  ...
                  <span>{Math.round((data.stats.budgetUsed / (data.stats.totalBudget || 1)) * 100) || 0}%</span>
                </div>
                <div className="w-full bg-primary-700/50 rounded-full h-2">
                  <div className="bg-white h-2 rounded-full shadow-sm" style={{ width: `${Math.round((data.stats.budgetUsed / (data.stats.totalBudget || 1)) * 100) || 0}%` }}></div>
                </div>
              </div>
